...
const I18N = {
    ...
    speciesNone: ["-- Select Species --", "প্রজাতি সিলেক্ট করুন"],
    ...
    speciesRoseicollis: ["<i>Agapornis roseicollis</i>", "<i>Agapornis roseicollis</i>"],
    speciesTaranta: ["<i>Agapornis taranta</i>", "<i>Agapornis taranta</i>"],
...
const customDictionary = [
    ...
    { keys: ["vio", "sf violet d blue", "violet d blue"], res: (sp) => [{id:"violet", val:1}, {id:"dark_factor", val:1}, {id: sp==="roseicollis"?"rose_blue":"blue1", val:2}] },
